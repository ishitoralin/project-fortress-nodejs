...
const categories = [
  ...
  },
  {
    name: '肌肥大循環課表訓練課程',
    description:
      '這個課程以肌肉量增加為目標，根據個人的身體能力安排適宜的訓練內容，以求最高效率的訓練成效，塑造個人理想中的完美體態與體格。',
  },
  {
    name: '長跑有氧耐力專門課程',
    description:
  ...
  { 
    ...
    description: 
      '本課程將由具有運動傷害預防與物理治療相關背景的教練進行，提供專業的暖身與伸展相關知識，讓你學習如何以正確的方式從事各項活動，能夠熟悉並理解身體狀態，降低受傷風險。' 
  },
  { 
    name: '瑜珈與身體活動度訓練課程', 
    description: '本課程旨在增加學員身體的活動度與伸展範圍，透過與瑜伽結合的訓練課程'
  },
  { 
    name: '壺鈴綜合訓練課程',
    description: '這是以壺鈴為主題設計的系列課程，學員將透過各項壺鈴的訓練動作，鍛煉身體的肌肉力量與協調能力以及' 
  },
  { 
    name: '藥球綜合訓練課程',
    description: ''
